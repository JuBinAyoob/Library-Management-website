...
<?php 
	...
	$sql="SELECT fine,department,sem FROM $tbl_name WHERE ID='$myuserid'";
...
?>
<meta http-equiv="content-type" content="text/html; charset=ISO-8859-1"><title>Student Page</title>
...
<ul>
<li><a class="nonactive" href="StudentPage.php">Home</a></li>
...
<table style="width: 95%; height: 750px; text-align: left; margin-left: auto; margin-right: auto;" border="0" cellpadding="1" cellspacing="0">
	...
	<tr>
		...
		<br>
		<br>
		Student Name: &nbsp;<?php echo '<span style="font-family: Tahoma; color: red;">'.$_SESSION['myusername'].'</span>'; ?><br>
		ID:&nbsp;<?php echo '<span style="font-family: Tahoma; color: red;">'.$_SESSION['ID'].'</span>'; ?><br>
		Semester:&nbsp;<?php echo '<span style="font-family: Tahoma; color: red;">'.$_SESSION['sem'].'</span>'; ?><br>
						...
						if(!empty($bk["$bookrequesti"]))
						{
							...
							else	
							{
								...
								echo '<td style="width: 264px; height: 350px; vertical-align: top; text-align: center;">
									...
									<input type="hidden" name="back" value="StudentPage.php">
