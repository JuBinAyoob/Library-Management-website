...
<html><head>
<meta http-equiv="content-type" content="text/html; charset=ISO-8859-1"><title>Student Login</title>
...
<tr>
<td>
<img style="width: 298px; height: 150px;" alt="Student Login" src="images/st-login.jpg" align="middle">
</td>
<td>
...
And Regulations For Students...</span></p>
<p><img style="float: right; width: 300px; height: 90px;" alt="" src="images/rris-student-login.jpg"></p>
<ul>
<li>Can Request for 5 Books...</li>
<li>At a Time only 3 Books can be accepted at your hand</li>
<li>Can renew Only one book at a time and can renew a book for 3 times....&nbsp;</li>
</ul>
<p>&nbsp;</p>
<table align="right" bgcolor="#cccccc" border="0" cellpadding="0" cellspacing="0" width="300">
<tbody>
<tr>
<form name="form2" method="post" action="Studentlogin.php">
<td>
<table bgcolor="#ffffff" border="0" cellpadding="3" cellspacing="1" width="100%">
<tbody>
<tr>
<td colspan="3"><strong>Student
Login </strong></td>
</tr>
<tr>
<td width="78">ID</td>
...
if(isset($_POST['myuserid'])&&isset($_POST['mypassword']))
{
	...
	if($count==1&&substr($myuserid,0,1)=='S')
	{
