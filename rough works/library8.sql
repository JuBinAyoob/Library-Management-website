...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2016 at 06:54 PM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `Accepted_Cancel`(IN `bkid` VARCHAR(15), IN `usid` VARCHAR(15), OUT `fuser` VARCHAR(15))
BEGIN
    ...
    IF (cou=1)THEN
        ...
        IF (F!=-1)THEN
        	SET @sql = CONCAT('SELECT c',F,' INTO fuser FROM bookrequests WHERE mainid ="',bkid,'"');
        	PREPARE stmt FROM @sql;
        	EXECUTE stmt;
        	DEALLOCATE PREPARE stmt;
            
            INSERT INTO notification (userid,bookid,type) VALUES(fuser,bkid,'accepted');
...
('CSES612201', 'CSES6122', 'embedded system design: a unified hardware/software introduction', 'frank vahid, tony givargis', 'wiley', '2002', 199, 'CSE', 'S6', 'embedded systems', 'SCS13044', '2016-02-18', 3),
...
('CSES612901', 'CSES6129', 'Introduction to Neural Networks using Matlab', 'S N Shivanandam, S Sumati, S N Deepa', 'Tata McGraw Hill', '', 600, 'CSE', 'S7', 'Artificial Neural Networks', 'SCS13218', '2016-05-01', 2);
...
(1, 'TCS10303', 'CSES6129', 0, '2016-04-17', 'accepted', 0),
...
('SCS13218', 'Jubin Ayoob', 31, 'CSE', 'S6', '2013-07-22', 'SYANECS028', 'jubinayoob369@gmail.com', 8129062800),
...
('SCS13218', 2, 'CSES612901', '', '', 'CSES6103', 'CSES6129', '', '', ''),
('SCS14001', 0, '', '', '', '', '', '', '', ''),
('TCS10303', -11, '', '', '', '', 'CSES6122', 'CSES6125', 'CSES6103', 'CSES6102'),
